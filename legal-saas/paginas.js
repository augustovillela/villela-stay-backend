...
function landingHTML() {
  ...
  return `<!DOCTYPE html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
    ...
    ${BRAND_HEAD}<link rel="stylesheet" href="/assets/brand/villela-ui.css?v=7"><link rel="stylesheet" href="/assets/brand/villela-saas.css?v=7">${GA}
...
function shell(corpo, script) {
  return `<!DOCTYPE html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
    <meta name="robots" content="noindex"><title>Villela Legal — Painel</title>${BRAND_HEAD}<link rel="stylesheet" href="/assets/brand/villela-ui.css?v=7"><link rel="stylesheet" href="/assets/brand/villela-saas.css?v=7"><style>${CSS}
