...
const PADRAO = [
  ...
  ['1.1.4.001', 'IRRF retido por clientes a recuperar', A, DEV, true, '', false],
  ['1.1.4.002', 'INSS retido por clientes a recuperar', A, DEV, true, '', false],
  ['1.1.4.003', 'ISS retido por clientes a recuperar', A, DEV, true, '', false],
  ['1.1.4.004', 'PIS/COFINS/CSLL retidos a recuperar', A, DEV, true, '', false],
  ...
  ['2.1.3.004', 'IRRF retido de terceiros a recolher', P, CRE, true, '', false],
  ['2.1.3.005', 'INSS retido de terceiros a recolher', P, CRE, true, '', false],
  ['2.1.3.006', 'ISS retido de terceiros a recolher', P, CRE, true, '', false],
  ['2.1.3.007', 'PIS/COFINS/CSLL retidos de terceiros a recolher', P, CRE, true, '', false],
  ...
  ['2.3.3', 'Implantação', PL, CRE, false, '', true],
  ['2.3.3.001', 'Saldos iniciais de implantação', PL, CRE, true, '', true],
  ...
  ['4.1.1.014', 'Depreciação', D, DEV, true, '', false],
...
const CHAVES = {
  ...
  // Retenção na fonte tem DOIS lados, e confundi-los é erro clássico:
  // o que o cliente retém de nós vira ATIVO (compensa tributo nosso);
  // o que nós retemos do fornecedor vira PASSIVO (temos de recolher).
  irrfRecuperar: '1.1.4.001',
  inssRecuperar: '1.1.4.002',
  issRecuperar: '1.1.4.003',
  pccRecuperar: '1.1.4.004',
  irrfRecolher: '2.1.3.004',
  inssRecolher: '2.1.3.005',
  issRecolher: '2.1.3.006',
  pccRecolher: '2.1.3.007',
  saldosIniciais: '2.3.3.001',
  imobilizado: '1.2.1.002',
  depreciacaoAcumulada: '1.2.1.900',
  depreciacaoDespesa: '4.1.1.014',
