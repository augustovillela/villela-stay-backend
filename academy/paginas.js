...
function appHTML() {
  return `<!DOCTYPE html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
    ...
    <script src="/academy/jornada.js?v=2"></script><script src="/academy/ecossistema.js?v=2"></script><script src="/academy/aluno.js?v=6"></script><script src="/academy/app.js?v=9"></script><script>bootAcademy();</script><script src="/academy/comunicados.js" data-cor="#1B2A4A" data-sino="nao" defer></script></body></html>`;
}
