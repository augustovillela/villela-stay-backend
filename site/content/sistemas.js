...
const EM_DESENVOLVIMENTO = [
  ...
  },
  {
    ...
    falta: T(
      'A cobrança recorrente já está no ar; falta um teste de intrusão e a revisão jurídica dos termos e do contrato de tratamento de dados antes de aceitar o primeiro assinante pagante. As análises de mercado e de leilões seguem fora do produto até haver parecer sobre o perímetro da CVM.',
      'Recurring billing is live; a penetration test and a legal review of the terms and data-processing agreement still come before the first paying subscriber. Market and auction analysis stay out of the product until there is an opinion on the Brazilian securities regulator’s perimeter.',
      'El cobro recurrente ya está activo; falta una prueba de intrusión y la revisión jurídica de los términos y del contrato de tratamiento de datos antes de aceptar al primer suscriptor de pago. Los análisis de mercado y de subastas siguen fuera del producto hasta que haya dictamen sobre el perímetro del regulador.')
  },
  {
