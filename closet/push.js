// =====================================================================
// Closet Club — Web Push do app (PWA). Assinaturas na tabela push_subs do
// banco do produto; envio pelo helper compartilhado ../push-saas.js (VAPID
// por env). Envio é sempre best-effort: nunca bloqueia uma rota.
// =====================================================================
'use strict';
